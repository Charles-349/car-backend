...
exports.CustomerTable = (0, pg_core_2.pgTable)("customer", {
    ...
    firstName: (0, pg_core_2.varchar)("FirstName", { length: 50 }).notNull(),
    lastName: (0, pg_core_2.varchar)("LastName", { length: 50 }).notNull(),
    email: (0, pg_core_2.varchar)("Email", { length: 100 }).notNull().unique(),
    password: (0, pg_core_2.varchar)("Password", { length: 255 }).notNull(), // hashed password
    phoneNumber: (0, pg_core_2.text)("PhoneNumber"),
    address: (0, pg_core_2.varchar)("Address", { length: 255 }),
    role: (0, exports.RoleEnum)("Role").default("user"), // default role is user
    image_url: (0, pg_core_2.varchar)("image_url", { length: 255 }).default("https://www.gravatar.com/avatar/00000000000000000000000000000000?d=mp&f=y"),
    isVerified: (0, pg_core_2.boolean)("is_verified").default(false), // to check if the user is verified  
    verificationCode: (0, pg_core_2.varchar)("verification_code", { length: 10 }), // to store the verification code sent to the user  
    verificationCodeExpiresAt: (0, pg_core_2.timestamp)("verification_code_expires_at", { mode: "date" })
});
// Location Table
...
exports.CarTable = (0, pg_core_2.pgTable)("car", {
    ...
    year: (0, pg_core_2.date)("Year").notNull(),
    color: (0, pg_core_2.varchar)("Color", { length: 30 }),
    rentalRate: (0, pg_core_2.decimal)("RentalRate", { precision: 10, scale: 2 }).notNull(),
    availability: (0, pg_core_2.boolean)("Availability").default(true),
    locationID: (0, pg_core_2.integer)("LocationID").references(() => exports.LocationTable.locationID, { onDelete: "set null" })
});
// Reservation Table
